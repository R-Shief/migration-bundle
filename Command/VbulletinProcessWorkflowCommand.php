...
use Rshief\Bundle\MigrationBundle\Compiler\TemplateDecompiler;
...
class VbulletinProcessWorkflowCommand extends ContainerAwareCommand
{
    ...
    public function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $repository = $em->getRepository('Rshief\Bundle\MigrationBundle\Entity\VBulletinRssFeed');
        $templates = array();
        ...
        $workflow
            ...
            ->addItemConverter(new CallbackItemConverter(function ($array) use ($em, $templates) {
                ...
                $repository = $em->getRepository('Rshief\Bundle\MigrationBundle\Entity\VBulletinThread');
            ...
            ->addItemConverter(new CallbackItemConverter(function ($array) use ($em) {
                ...
                /** @var \Rshief\Bundle\MigrationBundle\Entity\VBulletinRssFeed $feed */
